...
<div style="max-width:1000px;margin:0 auto;font-family:Arial,sans-serif;">
    ...
    <?php if (!empty($status)): ?>
        <div style="background:#d4edda;color:#155724;padding:16px;border-radius:10px;margin-bottom:20px;">✅ Alterações
            salvas com sucesso!</div>
    <?php endif; ?>
        ...
        <form method="post">
            ...
            <label style="display:block;margin-bottom:14px;">
                ...
                <input type="text" name="cargo" required
                    style="width:50%;padding:10px;border:1px solid #ccc;border-radius:8px;">
            </label>
            <button type="submit"
    ...
    <div>
        ...
        <?php else: ?>
            <?php foreach ($experiencias as $experiencia): ?>
                <form method="post"
                    style="background:#fff;border:1px solid #ddd;border-radius:12px;padding:20px;margin-bottom:16px;display:grid;grid-template-columns:1fr 140px;gap:12px;align-items:end;">
                    ...
                    <label style="display:block;">
                        <strong>Cargo</strong><br>
                        <input type="text" name="cargo" value="<?php echo esc_attr($experiencia['cargo']); ?>" required
                            style="width:50%;padding:10px;border:1px solid #ccc;border-radius:8px;">
                    </label>

                    <div style="display:flex;flex-direction:column;gap:8px;">
                        <button type="submit"
                            style="background:#2563eb;color:#fff;padding:12px 20px;border:none;border-radius:10px;cursor:pointer;"><i class="fa-solid fa-pen-to-square"></i></button>
                        </button>
                        <button type="submit" name="acao_experiencias" value="excluir_experiencia"
