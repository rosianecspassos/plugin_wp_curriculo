        ...
        <div style="background:#fff;border:1px solid #ddd;border-radius:12px;padding:24px;">
            ...
            <form method="post">
                ...
                <label style="display:block;margin-bottom:14px;">
                    ...
                    <select name="nivel_text" required
                        style="width:100%;padding:10px;border:1px solid #ccc;border-radius:8px;">
            ...
            <?php foreach ($languages as $idioma): ?>
                <form method="post"
                    ...
                    <label style="display:block;">
                        <strong>Nome</strong><br>
                        <input type="text" name="nome" value="<?php echo esc_attr($idioma['nome']); ?>" required
                            style="width:100%;padding:10px;border:1px solid #ccc;border-radius:8px;">
                    </label>
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px;">
                        ...
                        <button type="submit" name="acao_idiomas" value="excluir_idioma"
